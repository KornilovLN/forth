...
\ --- Test Сумма и разность квадратов ---------------
CR
." Сумма квадратов 5 и 4 " 4  5  SUM-QUAD  ." = " . CR
CR
." Разность квадратов 5 и 4 " 4  5  DIF-QUAD  ." = " . CR
CR
." Квадрат суммы 5 и 4 " 5  4  QUADSUM  ." = " . CR
CR
." Квадрат разности 8 и 4 " 8  4  QUADDIF  ." = " . CR
CR
